...
<form action="info_ok.jsp" name="regform" id="regform" method="post" onsubmit="return sendit()">
    ...
    <p>취미 :
        ...
        <label>요가<input type="checkbox" name="hobby" value="요가"></label>
        <label>헬스<input type="checkbox" name="hobby" value="헬스"></label>
    </p>
    <p>주민등록번호 : <input type="text" name="ssn1" id="ssn1" maxlength="6" value= <%=session.getAttribute("ssn1")%>> -
        <input type="password" name="ssn2" id="ssn2" value= <%=session.getAttribute("ssn2")%>> <input type="button" value="주민등록번호 검증" id="ssnBtn">
    </p>
    <p><label>우편번호 :
        <input type="text" name="zipcode" id="sample6_postcode" readonly value= <%=session.getAttribute("zipcode")%>></label>
