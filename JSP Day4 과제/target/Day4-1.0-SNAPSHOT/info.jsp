...
<form action="info_ok.jsp" name="regform" id="regform" method="post" onsubmit="return sendit()">
    ...
    <p><label>아이디 : <%=session.getAttribute("userid")%></label></p>
    <p><label>이름 : <input type="text" name="name" id="name" value= "<%=session.getAttribute("mem_name")%>"></label></p>
    <p><label>휴대폰 번호 : <input type="text" name="hp" id="hp" value= "<%=session.getAttribute("mem_hp")%>"></label></p>
    <p><label>이메일 : <input type="text" name="email" id="email" value= "<%=session.getAttribute("mem_email")%>"></label></p>
    <p>취미 :
    ...
    <p>주민등록번호 : <input type="text" name="ssn1" id="ssn1" maxlength="6" value= "<%=session.getAttribute("mem_ssn1")%>"> -
        <input type="password" name="ssn2" id="ssn2" value= "<%=session.getAttribute("mem_ssn2")%>"> <input type="button" value="주민등록번호 검증" id="ssnBtn">
    </p>
    <p><label>우편번호 :
        <input type="text" name="zipcode" id="sample6_postcode" readonly value= "<%=session.getAttribute("mem_zipcode")%>"></label>
        <input type="button" value="우편번호 검색" onclick="sample6_execDaumPostcode()">
    </p>
    <p><label>주소 : <input type="text" name="address1" id="sample6_address" value= "<%=session.getAttribute("mem_address1")%>"></label></p>
    <p><label>상세주소 : <input type="text" name="address2" id="sample6_detailAddress" value= "<%=session.getAttribute("mem_address2")%>"></label></p>
    <p><label>참고항목 : <input type="text" name="address3" id="sample6_extraAddress" value= "<%=session.getAttribute("mem_address3")%>"></label></p>
