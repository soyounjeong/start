...
<body>
    <h2>회원가입</h2>
    <!--body로 써서 보내기때문에 POST-->
    <!--submit이 발생되면 sendit이 먼저 호출 T/F로 판단하여 True가 되면 regist_ok.jsp로 보내게 되고 False가 되면 form이 submit되지 않음-->
    <form action="regist_ok.jsp" name="regform" id="regform" method="POST" onsubmit="return sendit()">
        ...
        <p>취미 : <label>드라이브 <input type="checkbox" name="hobby" value="드라이브"></label>
            ...
            <label>헬스 <input type="checkbox" name="hobby" value="헬스"></label></p>
        ...
        <!--submit은 무조건 post로 넘기게 됨 -->
        <!-- 방법1. 일반버튼으로 만들기(button)
